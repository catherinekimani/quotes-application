...
export class QuoteComponent implements OnInit {
  quotes: Quote[] = [
    new Quote(1, "FunnyTechQuote", "“Technology can be cool. I mean, think about it: when you see a dishwasher working or an iPhone loading up the next song on its playlist for your jog in the park  doesnt that feel like magic?”.", "By: Catherine Kimani", 1, 0, new Date(2022,4,10) ),
    ...
    new Quote(4, "TechQuote", "Technology has made our world so much smaller, that we can now learn about other cultures or countries with ease thanks to Youtube videos and online news stories!”", "By: Benard Kimani", 1, 0, new Date(2022,4,8)),
  ];
